...
import { X, Camera, FileText, MapPin, Calendar, AlertCircle } from "lucide-react"
            ...
            <div className="grid grid-cols-1 gap-2 text-sm ml-6">
              {infrastructure.installation_date && (
                <div>
                  ...
                  <span className="font-medium">{new Date(infrastructure.installation_date).toLocaleDateString()}</span>
                </div>
              )}
