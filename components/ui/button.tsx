  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary bg-background text-accent hover:bg-primary/10 active:bg-primary/20 shadow-sm",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 active:bg-secondary/80 shadow-sm",
        accent: "bg-accent text-white hover:bg-accent/90 active:bg-accent/80 shadow-sm",
        ghost: "hover:bg-secondary/50 text-accent active:bg-secondary/60 transition-colors",
