      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-border bg-muted/30">
            ...
            <th className="px-4 py-3 text-left text-sm font-semibold text-muted-foreground">Equipo o activo</th>
            ...
            <th className="px-4 py-3 text-left text-sm font-semibold text-muted-foreground">Ubicación / bodega</th>
        ...
        <tbody>
          {assets.map((asset) => (
            <tr key={asset.id} className="border-b border-border transition-colors hover:bg-muted/50" onMouseEnter={(event) => handleMouseEnter(event, asset.id)} onMouseLeave={() => setHoveredAssetId(null)}>
              ...
              <td className="px-4 py-3 text-sm text-muted-foreground">{asset.cost_center?.code || asset.cost_center?.name || <span className="text-amber-700">Sin centro</span>}</td>
              ...
              <td className="px-4 py-3 text-sm text-muted-foreground">{asset.location || <span className="text-amber-700">Sin ubicación</span>}</td>
