...
test("Farm Map is a separate real-GIS surface that uses reliable Leaflet raster rendering", async () => {
  ...
  assert.doesNotMatch(farmMap, /maplibre-gl|new maplibregl\.Map/)
