...
Reference Crop Map behavior: plantings are grouped by crop, each generation exposes start/end dates and required bed meters, and the user drags one planting at a time onto a bed. Partial bed occupation is valid and must preserve spatial bed-meter capacity across overlapping dates. The observed reference queue had 32 plantings. One Arugula generation of 9 bed m was successfully placed on bed 17, moving onboarding from 6/8 to 7/8.
