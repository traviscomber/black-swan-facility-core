...
const exact: Record<TargetLanguage, Record<string, string>> = {
  ...
  de: {
    ...
    "Preparación de habitación": "Zimmer­vorbereitung",
    ...
    "Servicios / cargos": "Services / Gebühren",
    "Monto extras": "Betrag Extras",
    "Servicios y cargos": "Services und Gebühren",
    "No hay servicios cargados y el catálogo aún está vacío.": "Es wurden keine Services hinzugefügt und der Katalog ist noch leer.",
    "No hay servicios cargados a esta reserva.": "Für diese Reservierung wurden keine Services hinzugefügt.",
    "Prioridad": "Priorität",
    "normal": "normal",
