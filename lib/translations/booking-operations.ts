...
export const bookingOperationsExact: Record<BookingOperationsTargetLocale, Record<string, string>> = {
  en: {
    ...
    "Nueva reserva": "New reservation", "Llegadas hoy": "Today's arrivals", "Salidas hoy": "Today's departures", "Ocupadas hoy": "Occupied today", "Habitaciones no listas": "Rooms not ready", "Limpiezas pendientes": "Pending cleanings", "Solicitudes abiertas": "Open requests",
    "Hoy": "Today", "Todas las propiedades": "All properties", "Buscar propiedad, habitación, cama o estado": "Search property, room, bed or status", "Propiedad / habitación / cama": "Property / room / bed", "Cargando operación…": "Loading operations…", "No hay habitaciones para los filtros seleccionados.": "No rooms match the selected filters.",
  ...
  de: {
    ...
    "Nueva reserva": "Neue Reservierung", "Llegadas hoy": "Heutige Anreisen", "Salidas hoy": "Heutige Abreisen", "Ocupadas hoy": "Heute belegt", "Habitaciones no listas": "Zimmer nicht bereit", "Limpiezas pendientes": "Offene Reinigungen", "Solicitudes abiertas": "Offene Anfragen",
    "Hoy": "Heute", "Todas las propiedades": "Alle Unterkünfte", "Buscar propiedad, habitación, cama o estado": "Unterkunft, Zimmer, Bett oder Status suchen", "Propiedad / habitación / cama": "Unterkunft / Zimmer / Bett", "Cargando operación…": "Betrieb wird geladen…", "No hay habitaciones para los filtros seleccionados.": "Keine Zimmer entsprechen den gewählten Filtern.",
    ...
    "Bloqueo": "Sperre", "Sin tipo": "Ohne Typ", "Retroceder siete días": "Sieben Tage zurück", "Avanzar siete días": "Sieben Tage vor", "Filtrar por propiedad": "Nach Unterkunft filtern", "Actualizar calendario": "Kalender aktualisieren",
    "Solicitudes históricas del huésped": "Frühere Gästeanfragen", "No hay solicitudes históricas vinculadas.": "Keine verknüpften früheren Anfragen.", "Sin fecha": "Kein Datum", "sin estado": "ohne Status", "Incidencias vinculadas": "Verknüpfte Vorfälle", "No hay incidencias vinculadas a esta reserva.": "Mit dieser Reservierung sind keine Vorfälle verknüpft.", "Incidencia": "Vorfall", "prioridad no registrada": "Priorität nicht erfasst",
