-- Fix audit action for canonical Budget mapping.
-- critical_action_audit_log.action only accepts INSERT/UPDATE/DELETE.
-- Preserve the semantic operation in new_data.operation.
...
begin
  ...
  insert into public.critical_action_audit_log(
    ...
    v_new||jsonb_build_object(
      'operation','assign_canonical_budget_mapping',
