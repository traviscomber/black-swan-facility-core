  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Energy Reports</h1>
          <p className="text-muted-foreground">Historical analysis and performance reports</p>
        </div>
          ...
          {["monthly", "building", "system"].map((type) => (
            <button
              ...
              className={`px-4 py-2 rounded-md font-medium transition-colors capitalize ${
                reportType === type ? "bg-primary text-primary-foreground" : "bg-card text-foreground hover:bg-accent"
              }`}
            >
              {type} Report
            </button>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-end gap-2">
                <button className="flex-1 px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90">
