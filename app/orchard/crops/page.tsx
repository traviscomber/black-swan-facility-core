...
const statuses = ["seedling", "growing", "mature", "harvested", "failed"] as const
const statusLabels = {
  en: { seedling: "Seedling", growing: "Growing", mature: "Mature", harvested: "Harvested", failed: "Failed" },
  es: { seedling: "Almácigo", growing: "En crecimiento", mature: "Maduro", harvested: "Cosechado", failed: "Fallido" },
  de: { seedling: "Jungpflanze", growing: "Im Wachstum", mature: "Reif", harvested: "Geerntet", failed: "Ausgefallen" },
} as const
const activityLabels: Record<"en" | "es" | "de", Record<string, string>> = {
  en: { watering: "Watering", feeding: "Feeding", weeding: "Weeding", pruning: "Pruning", cultivation: "Cultivation", inspection: "Inspection" },
  es: { watering: "Riego", feeding: "Fertilización", weeding: "Desmalezado", pruning: "Poda", cultivation: "Labranza", inspection: "Inspección" },
...
const copy = {
  en: { title: "Crops", description: "Operate every live crop from one visual cockpit with lineage, care, health, work and harvest context in view.", newCrop: "Create live crop", succession: "Planned succession", manual: "Manual / unplanned crop", plot: "Plot", crop: "Crop", type: "Crop type", variety: "Variety", planted: "Planting date", harvest: "Expected harvest", quantity: "Quantity planted", unit: "Unit", spacing: "Spacing (cm)", depth: "Depth (cm)", water: "Water frequency", yield: "Estimated yield", yieldUnit: "Yield unit", fertilizer: "Fertilizer schedule", notes: "Notes", create: "Create crop", refresh: "Refresh", loading: "Loading…", empty: "No operational crops in this scope.", saveError: "Could not save crop", delete: "Delete this crop and its related logs?", deleteAction: "Delete crop", actualYield: "Actual yield", actualHarvest: "Actual harvest", lineage: "Planning lineage", command: "Live crop operations", commandHelp: "See what is growing, where it lives, what happened recently and what is scheduled next.", active: "Active crops", mature: "Mature", healthObservations: "High-severity observations", openWork: "Open work", lastCare: "Last care", health: "Health observations", nextTask: "Next task", harvestIn: "Harvest in", days: "days", noCare: "No care logged", noHighSeverity: "No high-severity observations", recorded: "Recorded", noTask: "No open task", careAction: "Open care", healthAction: "Health observations", lifecycleAction: "Lifecycle", plannedLineage: "Planned", manualLineage: "Manual", fieldStatus: "Field status", scope: "Game Plan scope", allPlans: "All Game Plans", scopedHelp: "This view is controlled by the selected Game Plan. Open it to inspect the full seasonal plan.", openGamePlan: "Open Game Plan", planSnapshot: "Plan snapshot", successionRows: "succession rows", plannedCrops: "planned crops", allocatedBeds: "allocated beds", heroEyebrow: "Orchard · Operations", heroAlt: "Live vegetable crops growing in an active greenhouse" },
  es: { title: "Cultivos", description: "Opera cada cultivo vivo desde un cockpit visual con trazabilidad, cuidados, sanidad, trabajo y contexto de cosecha a la vista.", newCrop: "Crear cultivo vivo", succession: "Sucesión planificada", manual: "Cultivo manual / no planificado", plot: "Sector", crop: "Cultivo", type: "Tipo", variety: "Variedad", planted: "Fecha de plantación", harvest: "Cosecha esperada", quantity: "Cantidad plantada", unit: "Unidad", spacing: "Distancia (cm)", depth: "Profundidad (cm)", water: "Frecuencia de riego", yield: "Rendimiento estimado", yieldUnit: "Unidad rendimiento", fertilizer: "Plan de fertilización", notes: "Notas", create: "Crear cultivo", refresh: "Actualizar", loading: "Cargando…", empty: "No hay cultivos operativos en este alcance.", saveError: "No fue posible guardar el cultivo", delete: "¿Eliminar este cultivo y sus registros relacionados?", deleteAction: "Eliminar cultivo", actualYield: "Rendimiento real", actualHarvest: "Cosecha real", lineage: "Trazabilidad del plan", command: "Operación de cultivos vivos", commandHelp: "Mira qué está creciendo, dónde está, qué pasó recientemente y qué está programado después.", active: "Cultivos activos", mature: "Maduros", healthObservations: "Observaciones de alta severidad", openWork: "Trabajo abierto", lastCare: "Último cuidado", health: "Observaciones sanitarias", nextTask: "Próxima tarea", harvestIn: "Cosecha en", days: "días", noCare: "Sin cuidados registrados", noHighSeverity: "Sin observaciones de alta severidad", recorded: "Registradas", noTask: "Sin tarea abierta", careAction: "Abrir cuidados", healthAction: "Observaciones sanitarias", lifecycleAction: "Ciclo", plannedLineage: "Planificado", manualLineage: "Manual", fieldStatus: "Estado en terreno", scope: "Alcance Game Plan", allPlans: "Todos los Game Plans", scopedHelp: "Esta vista está controlada por el Game Plan seleccionado. Ábrelo para revisar el plan estacional completo.", openGamePlan: "Abrir Game Plan", planSnapshot: "Snapshot del plan", successionRows: "sucesiones", plannedCrops: "cultivos planificados", allocatedBeds: "camas asignadas", heroEyebrow: "Orchard · Operaciones", heroAlt: "Cultivos de hortalizas creciendo en un invernadero activo" },
  de: { title: "Kulturen", description: "Steuere jede aktive Kultur aus einem visuellen Cockpit mit Herkunft, Pflege, Pflanzengesundheit, Arbeit und Erntekontext.", newCrop: "Aktive Kultur anlegen", succession: "Geplante Folge", manual: "Manuelle / ungeplante Kultur", plot: "Parzelle", crop: "Kultur", type: "Kulturtyp", variety: "Sorte", planted: "Pflanzdatum", harvest: "Erwartete Ernte", quantity: "Gepflanzte Menge", unit: "Einheit", spacing: "Abstand (cm)", depth: "Tiefe (cm)", water: "Bewässerungsfrequenz", yield: "Geschätzter Ertrag", yieldUnit: "Ertragseinheit", fertilizer: "Düngeplan", notes: "Notizen", create: "Kultur anlegen", refresh: "Aktualisieren", loading: "Wird geladen…", empty: "Keine operativen Kulturen in diesem Umfang.", saveError: "Kultur konnte nicht gespeichert werden", delete: "Diese Kultur und die zugehörigen Protokolle löschen?", deleteAction: "Kultur löschen", actualYield: "Tatsächlicher Ertrag", actualHarvest: "Tatsächliche Ernte", lineage: "Planungsherkunft", command: "Aktive Kulturen steuern", commandHelp: "Sieh auf einen Blick, was wächst, wo es steht, was zuletzt passiert ist und was als Nächstes geplant ist.", active: "Aktive Kulturen", mature: "Reif", healthObservations: "Beobachtungen mit hoher Schwere", openWork: "Offene Arbeit", lastCare: "Letzte Pflege", health: "Pflanzengesundheit", nextTask: "Nächste Aufgabe", harvestIn: "Ernte in", days: "Tagen", noCare: "Keine Pflege erfasst", noHighSeverity: "Keine Beobachtungen mit hoher Schwere", recorded: "Erfasst", noTask: "Keine offene Aufgabe", careAction: "Pflege öffnen", healthAction: "Pflanzengesundheit", lifecycleAction: "Lebenszyklus", plannedLineage: "Geplant", manualLineage: "Manuell", fieldStatus: "Feldstatus", scope: "Game-Plan-Umfang", allPlans: "Alle Game Plans", scopedHelp: "Diese Ansicht wird vom ausgewählten Game Plan gesteuert. Öffne ihn, um den vollständigen Saisonplan zu prüfen.", openGamePlan: "Game Plan öffnen", planSnapshot: "Plan-Snapshot", successionRows: "Folgen", plannedCrops: "geplante Kulturen", allocatedBeds: "zugewiesene Beete", heroEyebrow: "Orchard · Betrieb", heroAlt: "Aktive Gemüsekulturen in einem Gewächshaus" },
} as const
...
export default function OrchardCropsPage() {
  ...
  const statusLabel = (value: string) => statusLabels[lang][value as keyof typeof statusLabels.en] ?? value.replaceAll("_", " ")
  const activityLabel = (value: string) => activityLabels[lang][value] ?? value.replaceAll("_", " ")
  ...
  const planCropSnapshot = useMemo(() => {
    const cycleLookup = new Map(scopedCycles.map((cycle) => [cycle.id, cycle]))
    const counts = new Map<string, number>()
    for (const succession of scopedSuccessions) {
      const cropName = cycleLookup.get(succession.crop_cycle_id)?.crop_name
      if (cropName) counts.set(cropName, (counts.get(cropName) ?? 0) + 1)
    }
    return [...counts.entries()].sort((a, b) => b[1] - a[1]).slice(0, 5)
  }, [scopedCycles, scopedSuccessions])
  const planSnapshotMax = Math.max(...planCropSnapshot.map(([, count]) => count), 1)
  ...
  return <AppLayout><PageHeader title={text.title} description={text.description} actions={<div className="flex flex-wrap gap-2"><Select value={selectedPlanId} onValueChange={changePlan}><SelectTrigger className="w-[240px]"><SelectValue /></SelectTrigger><SelectContent><SelectItem value={ALL_GAME_PLANS}>{text.allPlans}</SelectItem>{plans.map((plan) => <SelectItem key={plan.id} value={plan.id}>{gamePlanScopeLabel(plan, plan.name)}</SelectItem>)}</SelectContent></Select><Button variant="outline" onClick={() => void load()} disabled={loading}><RefreshCw className={`mr-2 h-4 w-4 ${loading ? "animate-spin" : ""}`} />{text.refresh}</Button></div>} /><OrchardNavigation /><div className="space-y-7 p-4 sm:p-8">
    ...
    {selectedPlan && <Link href={withGamePlanQuery(`/${language}/orchard/game-plan/season`, selectedPlanId)} className="group block border border-[var(--orchard-line)] bg-[var(--bs-surface-primary)] transition-colors hover:bg-[var(--bs-surface-secondary)]">
      <div className="grid gap-0 lg:grid-cols-[1.05fr_.95fr]">
        <div className="flex min-w-0 flex-col justify-between border-b border-[var(--orchard-line)] p-5 lg:border-b-0 lg:border-r">
          <div><p className="text-[10px] font-semibold uppercase tracking-[.16em] text-[var(--orchard-green)]">{text.planSnapshot}</p><div className="mt-2 flex items-start justify-between gap-4"><div><h2 className="text-xl font-medium tracking-[-.02em]">Game Plan {selectedPlan.season ?? ""}</h2><p className="mt-1 text-xs text-muted-foreground">{gamePlanScopeLabel(selectedPlan, selectedPlan.name)}</p></div><span className="inline-flex shrink-0 items-center gap-1.5 text-xs text-[var(--orchard-green)]">{text.openGamePlan}<ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5"/></span></div><p className="mt-4 max-w-2xl text-xs leading-5 text-muted-foreground">{text.scopedHelp}</p></div>
          <div className="mt-5 grid grid-cols-3 gap-px bg-[var(--orchard-line)]"><PlanMetric value={scopedSuccessions.length} label={text.successionRows}/><PlanMetric value={new Set(scopedCycles.map((cycle) => cycle.crop_name)).size} label={text.plannedCrops}/><PlanMetric value={new Set(scopedAllocations.map((item) => item.bed_id)).size} label={text.allocatedBeds}/></div>
        </div>
        <div className="p-5"><div className="flex h-full min-h-32 flex-col justify-center gap-3">{planCropSnapshot.map(([name, count]) => <div key={name} className="grid grid-cols-[minmax(7rem,1fr)_2fr_auto] items-center gap-3"><span className="truncate text-xs">{name}</span><div className="h-1.5 bg-[var(--orchard-line)]"><div className="h-full bg-[var(--orchard-green)]/75" style={{width:`${Math.max(8, count / planSnapshotMax * 100)}%`}}/></div><span className="text-[10px] tabular-nums text-muted-foreground">{count}</span></div>)}</div></div>
      </div>
    </Link>}

    <section className="relative min-h-[340px] overflow-hidden bg-neutral-950 text-white"><img src={cropsHero} alt={text.heroAlt} className="absolute inset-0 h-full w-full object-cover opacity-100 [filter:none]" /><div className="absolute inset-0" style={{background:"linear-gradient(90deg,rgba(5,8,7,.94),rgba(5,8,7,.66) 58%,rgba(5,8,7,.18)),linear-gradient(0deg,rgba(5,8,7,.72),rgba(5,8,7,.05) 60%)"}}/><div className="relative flex min-h-[340px] max-w-3xl flex-col justify-end p-6 sm:p-9"><p className="text-xs uppercase tracking-[.2em] text-white/60">{text.heroEyebrow}</p><h2 className="mt-3 text-4xl font-medium tracking-[-.04em] sm:text-5xl">{text.command}</h2><p className="mt-4 max-w-2xl text-sm leading-6 text-white/70">{text.commandHelp}</p><div className="mt-6 grid max-w-2xl grid-cols-2 gap-px bg-white/10 sm:grid-cols-4"><HeroMetric label={text.active} value={activeCrops.length} /><HeroMetric label={text.mature} value={scopedCrops.filter((crop) => crop.status === "mature").length} /><HeroMetric label={text.healthObservations} value={highSeverityObservations} /><HeroMetric label={text.openWork} value={openTasks.length} /></div></div></section>
...
function PlanMetric({ label, value }: { label: string; value: number }) { return <div className="bg-[var(--bs-surface-secondary)] p-3"><p className="text-lg font-medium tabular-nums">{value}</p><p className="mt-0.5 text-[10px] uppercase tracking-[.1em] text-muted-foreground">{label}</p></div> }
