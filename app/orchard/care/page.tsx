...
export default function OrchardCarePage() {
  ...
  return <AppLayout><OrchardNavigation /><main className="mx-auto w-full max-w-[1560px] space-y-8 px-4 pb-20 pt-4 sm:px-6 lg:px-8">
    <section className="relative min-h-[360px] overflow-hidden bg-neutral-950 text-white sm:min-h-[420px]">
      ...
      <div className="absolute bottom-6 right-6 hidden grid-cols-2 gap-px bg-white/10 lg:grid"><HeroMetric label={text.total} value={logs.length} /><HeroMetric label={text.today} value={todayCount} /><HeroMetric label={text.active} value={activeCrops} /><HeroMetric label={text.evidence} value={logs.length} /></div>
    </section>
