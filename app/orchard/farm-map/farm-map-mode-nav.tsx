...
export function FarmMapModeNav(){
 ...
 return <nav className="absolute right-4 top-[84px] z-[600] flex border border-white/15 bg-[#171715]/94 text-[11px] shadow-xl backdrop-blur-sm md:top-[68px]" aria-label={text.label}>
