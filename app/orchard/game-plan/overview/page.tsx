...
const sections:Section[]=[
  ...
  {href:"/orchard/game-plan/season",icon:CalendarRange,title:{en:"Season plan",es:"Plan de temporada",de:"Saisonplan"},description:{en:"Codified Game Plan, crop cycles and successions.",es:"Game Plan codificado, ciclos y sucesiones.",de:"Kodifizierter Game Plan, Kulturzyklen und Folgen."}},
  {href:"/orchard/game-plan/crop-chart",icon:BookOpen,title:{en:"Crop Chart",es:"Crop Chart",de:"Crop Chart"},description:{en:"Agronomic parameters, propagation, spacing, yield and crop evidence.",es:"Parámetros agronómicos, propagación, distancias, rendimiento y evidencia.",de:"Anbauparameter, Vermehrung, Abstände, Ertrag und Evidenz."}},
  {href:"/orchard/game-plan/propagation",icon:Sprout,title:{en:"Sowing & nursery",es:"Siembra y almácigo",de:"Aussaat & Anzucht"},description:{en:"Direct sow, transplant dates, seeder calibration and nursery reference.",es:"Siembra directa, fechas de trasplante, calibración y referencia de almácigo.",de:"Direktsaat, Pflanztermine, Sämaschinenkalibrierung und Anzuchtreferenz."}},
  {href:"/orchard/game-plan/tasks",icon:CalendarDays,title:{en:"Calendar & tasks",es:"Calendario y tareas",de:"Kalender & Aufgaben"},description:{en:"Crop Associated Task converted into a dated planning calendar.",es:"Crop Associated Task convertido en calendario de planificación con fechas.",de:"Crop Associated Task als datierter Planungskalender."}},
  {href:"/orchard/game-plan/capacity",icon:Map,title:{en:"Beds & capacity",es:"Camas y capacidad",de:"Beete & Kapazität"},description:{en:"Physical capacity only where bed identity is verified.",es:"Capacidad física sólo donde la identidad de camas está verificada.",de:"Physische Kapazität nur bei verifizierter Beetidentität."}},
  ...
  {href:"/orchard/harvest/desk",icon:Leaf,title:{en:"Harvest",es:"Cosecha",de:"Ernte"},description:{en:"Planned harvest windows and actual traceable output.",es:"Ventanas planificadas de cosecha y producción real trazable.",de:"Geplante Erntefenster und reale rückverfolgbare Produktion."}},
]
