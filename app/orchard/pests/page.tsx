...
export default function OrchardPestsPage() {
  ...
  return <AppLayout><OrchardNavigation /><main className="mx-auto w-full max-w-[1560px] space-y-8 px-4 pb-20 pt-4 sm:px-6 lg:px-8">
    <section className="relative min-h-[360px] overflow-hidden border border-white/10 bg-[#171512] text-white sm:min-h-[420px]">
      <div className="absolute inset-0 opacity-80" style={{background:"radial-gradient(circle at 82% 24%,rgba(139,203,168,.14),transparent 28%),linear-gradient(135deg,rgba(139,203,168,.05),transparent 46%)"}}/>
      <div className="absolute right-8 top-8 hidden h-40 w-40 place-items-center rounded-full border border-white/10 bg-white/[.02] text-[#8bcba8] lg:grid"><ShieldAlert className="h-16 w-16"/></div>
