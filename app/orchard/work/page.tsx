...
const WORK_HERO: Photo = { src: image("1500937386664-56d1dfef3854", 2200), alt: "Hands working carefully among rows of healthy crops" }
const WORK_PHOTOS: Photo[] = [
  { src: image("1464226184884-fa280b87c399"), alt: "Hands tending vegetables in a field" },
  { src: image("1416879595882-3373a0480b5b"), alt: "Fresh produce and farm work" },
  { src: image("1488459716781-31db52582fe9"), alt: "Vegetable rows in productive farmland" },
  { src: image("1518977676601-b53f82aba655"), alt: "Leafy crops ready for field work" },
]
const CROP_PHOTOS: Record<string, Photo> = {
  Tomato: { src: "https://unsplash.com/photos/WHHbA0kU8Qg/download?force=true&w=1800", alt: "Tomato plants growing in a greenhouse" },
  Lettuce: { src: "https://unsplash.com/photos/SXztF2mpCTA/download?force=true&w=1800", alt: "Fresh lettuce in a garden bed" },
  Onion: { src: "https://unsplash.com/photos/e3F37BvB5Vg/download?force=true&w=1800", alt: "Onions growing in soil" },
  Arugula: { src: "https://unsplash.com/photos/vlQ0g2jCgA4/download?force=true&w=1800", alt: "Arugula growing in a planter" },
  Radish: { src: "https://unsplash.com/photos/jU2Vv-it18c/download?force=true&w=1800", alt: "Radish growing in soil" },
  Carrot: { src: "https://unsplash.com/photos/4yK8iDaWnm8/download?force=true&w=1800", alt: "Fresh carrots after harvest" },
  Basil: { src: "https://unsplash.com/photos/T4uyB67uZ40/download?force=true&w=1800", alt: "Fresh basil leaves" },
}
...
export default function OrchardWorkPage() {
  ...
  useEffect(() => {
    if (loading || !focusedEntity || !tasks.some((task) => task.id === focusedEntity)) return
    window.setTimeout(() => document.getElementById(`task-${focusedEntity}`)?.scrollIntoView({ behavior: "smooth", block: "center" }), 120)
  }, [loading, focusedEntity, tasks])
  ...
  return <AppLayout>
    ...
    <main className="mx-auto w-full max-w-[1560px] space-y-10 px-4 pb-16 pt-4 sm:px-6 lg:px-8">
      <section className="relative isolate min-h-[360px] overflow-hidden bg-neutral-950 sm:min-h-[420px]">
        <img src={WORK_HERO.src} alt={WORK_HERO.alt} className="absolute inset-0 h-full w-full object-cover opacity-100 [filter:none]" />
