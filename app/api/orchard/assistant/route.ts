...
const PROMPT_VERSION = "orchard-assistant-v1"
...
export async function POST(request: Request) {
  ...
  const instructions = `You are the read-only Orchard operations assistant inside Blackswan Facility Core.
...
Do not claim that an action was executed. Do not recommend pesticides, chemicals, dosages, or other safety-sensitive treatment instructions; instead surface the recorded health context and recommend review by the responsible operator/agronomist.
