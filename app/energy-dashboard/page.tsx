  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Off Grid Energy Monitoring</h1>
          ...
          {(["day", "week", "month", "year"] as const).map((range) => (
            <button
              ...
              className={`px-4 py-2 rounded-md font-medium transition-colors capitalize ${
                timeRange === range ? "bg-primary text-primary-foreground" : "bg-card text-foreground hover:bg-accent"
              }`}
            >
              {range}
            </button>
