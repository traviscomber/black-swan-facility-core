...
export default function RevenueIntelligencePage() {
  ...
  const loadData = useCallback(async () => {
    ...
    if (firstError) { setError(firstError.message); setRows([]); setLoading(false); return }
