...
export default function BookingsLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs = useMemo<BookingTab[]>(() => [
    ...
    { value: "charges", route: "/bookings/charges", label: copy.charges, icon: ReceiptText, action: "payments.record", department: "finance" },
    ...
    { value: "payments", route: "/bookings/payments", label: copy.payments, icon: CreditCard, action: "payments.record", department: "finance" },
    { value: "invoices", route: "/bookings/invoices", label: copy.invoices, icon: FileText, action: "payments.record", department: "finance" },
