...
export default function MessageTemplatesPage() {
  ...
  return <section className="min-h-screen bg-[#171512] text-[#e7e1d8]">
    <header className="flex min-h-[58px] items-center justify-between gap-3 bg-[#211e1a] px-4 py-3">
      <div><h1 className="text-base font-normal">{c.title}</h1><p className="text-xs text-[#b9b0a4]">{c.subtitle} · {rows.length}</p></div>
    ...
    <div className="divide-y divide-[#39342d]">
      {rows.length===0?<div className="p-8 text-sm text-[#8f867b]">{c.empty}</div>:rows.map(row=><article key={row.id} className="bg-[#171512] p-4 hover:bg-[#1d1a17]">
