...
export default function BookingQuotesPage() {
  ...
  return <div className="min-h-screen bg-background p-4 md:p-6"><div className="mx-auto max-w-7xl space-y-5">
    ...
    <Card><CardHeader><CardTitle>{copy.parameters}</CardTitle></CardHeader><CardContent className="space-y-5">
      <div className="grid gap-4 md:grid-cols-5"><Field label="Check-in"><Input type="date" value={form.check_in} onChange={(event) => setForm({ ...form, check_in: event.target.value })} /></Field><Field label="Check-out"><Input type="date" value={form.check_out} onChange={(event) => setForm({ ...form, check_out: event.target.value })} /></Field><Field label="Adults"><Input type="number" min="1" value={form.adults} onChange={(event) => setForm({ ...form, adults: event.target.value })} /></Field><Field label="Children 0–3"><Input type="number" min="0" value={form.children_0_3} onChange={(event) => setForm({ ...form, children_0_3: event.target.value })} /></Field><Field label="Children 4–10"><Input type="number" min="0" value={form.children_4_10} onChange={(event) => setForm({ ...form, children_4_10: event.target.value })} /></Field></div>
