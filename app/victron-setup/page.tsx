...
def main():
    print("Victron VRM Data Fetcher Started")
    ...
    while True:
        try:
            # Fetch current data
            raw_data = fetch_device_data()
            if raw_data:
                processed_data = process_data(raw_data)
                print(f"[{datetime.now().strftime('%H:%M:%S')}] Data fetched successfully")
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="mx-auto max-w-4xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Victron Energy System Setup</h1>
          <p className="text-muted-foreground">Complete integration guide for Prairie House monitoring</p>
        </div>
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="border-t border-border pt-4">
              ...
              <p className="text-sm text-muted-foreground">
                Ensure InfluxDB data source is configured correctly. Verify Node-RED is writing data to InfluxDB. Check
                InfluxDB logs for errors.
              </p>
            </div>
            <div className="border-t border-border pt-4">
