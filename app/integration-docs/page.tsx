  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="mx-auto max-w-6xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Integration Documentation</h1>
          <p className="text-muted-foreground">
            Connect your Victron Energy system to monitoring dashboards and open-source tools
          </p>
        </div>
