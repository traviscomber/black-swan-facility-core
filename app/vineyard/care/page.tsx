...
export default function VineyardCarePage() {
  ...
  return <div className="space-y-6">
    ...
    <Card><CardHeader><CardTitle>{text.activityTitle}</CardTitle><CardDescription>{text.activityDescription}</CardDescription></CardHeader><CardContent>
      ...
      </div><div className="flex gap-2"><Button size="sm" variant="outline" aria-label="Edit"><Pencil className="h-4 w-4" /></Button><Button size="sm" variant="outline" className="text-destructive" aria-label="Delete"><Trash2 className="h-4 w-4" /></Button></div></div>)}</div>}
    </CardContent></Card>
  </div>
}
