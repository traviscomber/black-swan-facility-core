...
const COPY = {
  en: { title: "Operational tasks", description: "Current Black Swan work first. Historical Asana imports and demo work remain available, but no longer distort the live operational queue.", newTask: "New task", loadError: "Tasks could not be loaded.", overdueOne: "overdue operational task", overdueMany: "overdue operational tasks", overdueDetail: "This alert excludes historical Asana imports and demo tasks. Review, complete or cancel while preserving history.", pending: "Current operation", today: "Due today", completedWeek: "Completed this week", assignees: "Assignees on current work", tabOperation: "Current operation", tabAsanaLegacy: "Asana legacy", tabDemo: "Demo", tabCompleted: "Completed", tabCancelled: "Cancelled", tabAll: "All", workList: "Work list", workListDetail: "The default view contains only current Black Swan operational work. Legacy Asana and demo tasks are separated explicitly.", loading: "Loading tasks…", empty: "No tasks in this view.", emptyHint: "Use a Black Swan template or create work from an operational module.", animal: "Animal handling", overdue: "Overdue", noAssignee: "No assignee", select: "Select a task to review its details, assignees, source and safety.", statusPending: "Pending", statusProgress: "In progress", statusCompleted: "Completed", statusCancelled: "Cancelled", low: "Low", medium: "Medium", high: "High", urgent: "Urgent", asanaLegacyBadge: "Asana legacy", demoBadge: "Demo" },
  es: { title: "Tareas operativas", description: "Primero el trabajo vigente de Black Swan. Las importaciones históricas de Asana y las tareas demo siguen disponibles, pero ya no distorsionan la cola operacional.", newTask: "Nueva tarea", loadError: "No fue posible cargar las tareas.", overdueOne: "tarea operacional vencida", overdueMany: "tareas operacionales vencidas", overdueDetail: "Esta alerta excluye importaciones históricas de Asana y tareas demo. Revisar, completar o cancelar conservando el historial.", pending: "Operación actual", today: "Con fecha para hoy", completedWeek: "Completadas esta semana", assignees: "Responsables en trabajo vigente", tabOperation: "Operación actual", tabAsanaLegacy: "Asana legado", tabDemo: "Demo", tabCompleted: "Completadas", tabCancelled: "Canceladas", tabAll: "Todas", workList: "Lista de trabajo", workListDetail: "La vista inicial contiene sólo trabajo operacional vigente de Black Swan. El legado Asana y las tareas demo quedan separados explícitamente.", loading: "Cargando tareas…", empty: "No hay tareas en esta vista.", emptyHint: "Usa una plantilla de Black Swan o crea un trabajo desde un módulo operativo.", animal: "Manejo animal", overdue: "Vencida", noAssignee: "Sin responsable", select: "Selecciona una tarea para revisar su detalle, responsables, origen y seguridad.", statusPending: "Pendiente", statusProgress: "En curso", statusCompleted: "Completada", statusCancelled: "Cancelada", low: "Baja", medium: "Media", high: "Alta", urgent: "Urgente", asanaLegacyBadge: "Asana legado", demoBadge: "Demo" },
  de: { title: "Operative Aufgaben", description: "Aktuelle Black-Swan-Arbeit zuerst. Historische Asana-Importe und Demo-Aufgaben bleiben verfügbar, verfälschen aber nicht mehr die operative Warteschlange.", newTask: "Neue Aufgabe", loadError: "Aufgaben konnten nicht geladen werden.", overdueOne: "überfällige operative Aufgabe", overdueMany: "überfällige operative Aufgaben", overdueDetail: "Diese Warnung schließt historische Asana-Importe und Demo-Aufgaben aus. Prüfen, abschließen oder stornieren und den Verlauf erhalten.", pending: "Aktueller Betrieb", today: "Heute fällig", completedWeek: "Diese Woche abgeschlossen", assignees: "Verantwortliche für aktuelle Arbeit", tabOperation: "Aktueller Betrieb", tabAsanaLegacy: "Asana Altbestand", tabDemo: "Demo", tabCompleted: "Abgeschlossen", tabCancelled: "Storniert", tabAll: "Alle", workList: "Arbeitsliste", workListDetail: "Die Standardansicht enthält nur aktuelle operative Black-Swan-Arbeit. Asana-Altbestand und Demo-Aufgaben sind separat ausgewiesen.", loading: "Aufgaben werden geladen…", empty: "Keine Aufgaben in dieser Ansicht.", emptyHint: "Verwende eine Black-Swan-Vorlage oder erstelle Arbeit aus einem operativen Modul.", animal: "Tierhandling", overdue: "Überfällig", noAssignee: "Keine verantwortliche Person", select: "Wähle eine Aufgabe, um Details, Verantwortliche, Quelle und Sicherheit zu prüfen.", statusPending: "Ausstehend", statusProgress: "In Bearbeitung", statusCompleted: "Abgeschlossen", statusCancelled: "Storniert", low: "Niedrig", medium: "Mittel", high: "Hoch", urgent: "Dringend", asanaLegacyBadge: "Asana Altbestand", demoBadge: "Demo" },
} as const
