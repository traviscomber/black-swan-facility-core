...
const COPY = {
  es: {
    ...
    accountingNote: "Los snapshots históricos siguen separados en Tareas → Asana por conciliar y no se mezclan con esta vista personal.",
  ...
  en: {
    ...
    accountingNote: "Historical snapshots remain separate under Tasks → Asana reconciliation and are not mixed into this personal view.",
  ...
  de: {
    ...
    accountingNote: "Historische Snapshots bleiben unter Aufgaben → Asana-Abgleich getrennt und werden nicht mit dieser persönlichen Ansicht vermischt.",
